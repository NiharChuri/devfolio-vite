...
const Navbar = ({ scrollToSection }) => {
  ...
  useEffect(() => {
    const sections = navItems.map(item => document.querySelector(`#${item.section}`));

    const observerOptions = {
      root: null,
      rootMargin: '0px',
      threshold: 0.5 // Adjust this threshold based on when you want to trigger the active state
    };
